...
| Analytics | Top Customers | FAIL | SQLSTATE[42703]: Undefined column: 7 ERROR:  column c.name does not exist
LINE 3:                 c.name as customer_name,
                        ^ |
| Analytics | Aging Report | FAIL | SQLSTATE[42703]: Undefined column: 7 ERROR:  column c.name does not exist
LINE 3:                 c.name as customer_name,
                        ^ |
...
- Analytics: Top Customers - SQLSTATE[42703]: Undefined column: 7 ERROR:  column c.name does not exist
LINE 3:                 c.name as customer_name,
                        ^
- Analytics: Aging Report - SQLSTATE[42703]: Undefined column: 7 ERROR:  column c.name does not exist
LINE 3:                 c.name as customer_name,
                        ^
