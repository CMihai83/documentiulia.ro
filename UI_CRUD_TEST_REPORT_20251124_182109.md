...
- ✅ **Employee created successfully**
  - 📝 Employee ID: 2b60900c-84dd-415c-8295-a5fceaf9e2d6
  - 📝 Name: Test Employee UI Test, Position: Software Developer, Salary: 8000 RON
- ✅ **Employees listed successfully: 25 employees found**

## 3. CRM - Opportunity Management

- ✅ **Opportunity created successfully**
  - 📝 Opportunity ID: ac945d86-dd8d-40c7-b923-353ecb354b92
...
- ✅ **Expense created successfully**
  - 📝 Expense ID: 63501c88-446c-4c74-964b-8d468761db95
  - 📝 Amount: 350.50 RON, Category: Office Supplies, Status: Pending
- ✅ **Expense approved successfully**

## 5. Invoice Management

  - 📝 Could not get or create customer
...
## 6. Bill Management (Supplier Invoices)
  ...
  - 📝 Could not get or create vendor
...
- ✅ **Project created successfully**
  - 📝 Project ID: 37ed9a91-8236-43e8-abda-5f9152fe3dbc
...
- **Employee:** 2b60900c-84dd-415c-8295-a5fceaf9e2d6 (Test Employee UI Test)
- **Opportunity:** ac945d86-dd8d-40c7-b923-353ecb354b92 (New Software Development Project - 150,000 RON)
- **Expense:** 63501c88-446c-4c74-964b-8d468761db95 (Office Supplies - 350.50 RON)
- **Invoice:**  (TEST-INV-001 - 28,560 RON)
- **Bill:**  (ELEC-2025-11-001 - 1,487.50 RON)
- **Product:**  (Laptop Dell Latitude 5540)
- **Project:** 37ed9a91-8236-43e8-abda-5f9152fe3dbc (Website Redesign 2025)
