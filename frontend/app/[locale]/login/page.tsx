        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-400 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-registru-stampila focus:border-blue-500 sm:text-sm"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-blue-600 focus:ring-registru-stampila border-gray-300 rounded"
                checked={rememberMe}
          ...
          <div>
            <button
              type="submit"
              disabled={isLoading}
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-registru-cerneala hover:bg-registru-stampila focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-registru-stampila disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {isLoading ? (
