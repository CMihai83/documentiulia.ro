...
export default function AuditLogsPage() {
  ...
  const fetchLogs = async () => {
    try {
      ...
      // Honest empty state — an audit trail must never show fabricated entries.
      setError('Nu am putut încărca jurnalul de audit. Reîncearcă. / Could not load the audit log. Please retry.');
      setLogs([]);
      setStats(null);
    } finally {
      setLoading(false);
