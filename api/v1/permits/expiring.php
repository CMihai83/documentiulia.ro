<?php
/**
 * Expiring Permits API
 * Returns permits expiring within specified days
 */
...
try {
    ...
    $daysAhead = min(max($daysAhead, 7), 180);

    $expiring = $permitService->getExpiringPermits($companyId, $daysAhead);
