<?php
/**
 * Driver Performance Metrics API
 * GET /api/v1/delivery/performance/metrics.php?driver_id=xxx
 */
...
try {
    ...
    $metrics = $deliveryService->getDriverMetrics($driverId, $dateFrom, $dateTo);
