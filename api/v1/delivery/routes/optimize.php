...
/**
 * Optimize Route API
 * POST /api/v1/delivery/routes/optimize.php?id=xxx
 * Optimizes stop order using nearest-neighbor algorithm
 */
...
try {
    ...
    $route = $deliveryService->optimizeRoute($companyId, $routeId);
