<?php
/**
 * Customer Active Deliveries API (Public)
 * GET /api/v1/delivery/portal/active.php?phone=xxx OR ?email=xxx
 */
...
try {
    ...
    $deliveries = $deliveryService->getCustomerActiveDeliveries($identifier);
