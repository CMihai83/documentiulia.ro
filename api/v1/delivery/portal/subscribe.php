<?php
/**
 * Subscribe to Delivery Updates API (Public)
 * POST /api/v1/delivery/portal/subscribe.php?package_id=xxx
 */
...
try {
    ...
    $subscription = $deliveryService->subscribeToUpdates($packageId, $input);
