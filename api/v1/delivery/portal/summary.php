<?php
/**
 * Customer Portal Summary API (Public)
 * GET /api/v1/delivery/portal/summary.php?phone=xxx OR ?email=xxx
 */
...
try {
    ...
    $summary = $deliveryService->getCustomerPortalSummary($identifier);
