<?php
/**
 * Convert Estimate to Project API
 * POST - Convert accepted estimate to project
 */
...
try {
    ...
    if (!$estimateId) {
        throw new Exception('estimate_id required');
    }

    $estimateService = ConstructionEstimateService::getInstance();
    $project = $estimateService->convertToProject($companyId, $estimateId);
