<?php
/**
 * Profitability Trends API
 * E3-US09: Monthly profitability trends
 */
...
try {
    ...
    $months = min(max($months, 3), 36); // Between 3 and 36 months

    $trends = $profitService->getTrends($companyId, $months);
