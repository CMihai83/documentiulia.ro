...
| Invoices | Read | PASS | Get single invoice |
...
| Journal | Create | PASS | Create journal entry |
...
| Contacts | Update | FAIL | No valid fields to update |
| Contacts | Delete | FAIL | SQLSTATE[22P02]: Invalid text representation: 7 ERROR:  invalid input syntax for type uuid: "delete.php"
...
| AI | Business Insights | PASS | Get business insights |
...
| Module | Operation | Status | Details |
|--------|-----------|--------|---------|
| Context | Get | PASS | Get personal context |
...
- Contacts: Update - No valid fields to update
- Contacts: Delete - SQLSTATE[22P02]: Invalid text representation: 7 ERROR:  invalid input syntax for type uuid: "delete.php"
CONTEXT:  unnamed portal parameter $1 = '...'
