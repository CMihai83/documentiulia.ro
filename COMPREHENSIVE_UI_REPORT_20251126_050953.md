...
| CoA | Custom | FAIL | SQLSTATE[42703]: Undefined column: 7 ERROR:  column "account_code" does not exist
LINE 5:                     account_code,
                            ^
HINT:  Perhaps you meant to reference the column "chart_of_accounts.account_type". |
...
| Bank | Stats | FAIL | SQLSTATE[42703]: Undefined column: 7 ERROR:  column "connection_id" does not exist
LINE 5:             COUNT(DISTINCT connection_id) as active_connecti...
                                   ^ |
...
| AI | Business Insights | FAIL | User ID is required |
...
| MBA | Progress | FAIL | user_id is required |
| MBA | Recommendations | FAIL | Method not allowed |
...
| Module | Operation | Status | Details |
|--------|-----------|--------|---------|
| Context | Get | FAIL | User ID is required |
| Context | Templates | PASS | Get templates |

## 40. Notifications
| Module | Operation | Status | Details |
|--------|-----------|--------|---------|
| Notifs | List | FAIL | user_id is required |
...
- CoA: Custom - SQLSTATE[42703]: Undefined column: 7 ERROR:  column "account_code" does not exist
LINE 5:                     account_code,
                            ^
HINT:  Perhaps you meant to reference the column "chart_of_accounts.account_type".
...
- Bank: Stats - SQLSTATE[42703]: Undefined column: 7 ERROR:  column "connection_id" does not exist
LINE 5:             COUNT(DISTINCT connection_id) as active_connecti...
                                   ^
...
- AI: Business Insights - User ID is required
- Forum: Threads - Category ID required
- Courses: Enrollments - Unknown error
- MBA: Progress - user_id is required
- MBA: Recommendations - Method not allowed
- Sub: Invoices - Unknown error
- Context: Get - User ID is required
- Notifs: List - user_id is required
