...
| Analytics | Top Customers | FAIL | SQLSTATE[42703]: Undefined column: 7 ERROR:  column i.contact_id does not exist
LINE 10:              LEFT JOIN invoices i ON c.id = i.contact_id
                                                     ^ |
| Analytics | Aging Report | FAIL | SQLSTATE[42703]: Undefined column: 7 ERROR:  column i.contact_id does not exist
LINE 11:              JOIN invoices i ON c.id = i.contact_id
                                                ^ |
...
- Analytics: Top Customers - SQLSTATE[42703]: Undefined column: 7 ERROR:  column i.contact_id does not exist
LINE 10:              LEFT JOIN invoices i ON c.id = i.contact_id
                                                     ^
- Analytics: Aging Report - SQLSTATE[42703]: Undefined column: 7 ERROR:  column i.contact_id does not exist
LINE 11:              JOIN invoices i ON c.id = i.contact_id
                                                ^
