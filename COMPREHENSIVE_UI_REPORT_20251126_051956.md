...
| Analytics | Aging Report | FAIL | SQLSTATE[42703]: Undefined column: 7 ERROR:  column i.paid_amount does not exist
LINE 4: ...N i.due_date >= $1 THEN i.total_amount - COALESCE(i.paid_amo...
                                                             ^ |
...
- Analytics: Aging Report - SQLSTATE[42703]: Undefined column: 7 ERROR:  column i.paid_amount does not exist
LINE 4: ...N i.due_date >= $1 THEN i.total_amount - COALESCE(i.paid_amo...
                                                             ^
