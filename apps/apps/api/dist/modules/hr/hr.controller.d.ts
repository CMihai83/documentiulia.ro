...
import { CreateCandidateDto, UpdateCandidateDto, CreateJobDto, UpdateJobDto, CreateEmployeeDto, UpdateEmployeeDto, CreatePerformanceReviewDto, WellnessSurveyDto, ATSMatchRequestDto, CandidateStatus, JobStatus } from './dto/hr.dto';
export declare class HrController {
    ...
    getCandidates(companyId: string, status?: CandidateStatus, jobId?: string, minScore?: number, search?: string, page?: number, limit?: number): Promise<{
        data: ({
            job: {
                id: string;
                createdAt: Date;
    ...
    deleteCandidate(companyId: string, candidateId: string): Promise<void>;
    ...
    getJobs(companyId: string, status?: JobStatus, department?: string): Promise<({
        _count: {
            candidates: number;
        };
    } & {
    ...
    matchCandidates(companyId: string, dto: ATSMatchRequestDto): Promise<import("./dto/hr.dto").ATSMatchResultDto[]>;
    ...
    getAnalytics(companyId: string): Promise<import("./dto/hr.dto").HRAnalyticsDto>;
}
