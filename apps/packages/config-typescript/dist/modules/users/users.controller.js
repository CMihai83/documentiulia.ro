...
__decorate([
    (0, common_1.Get)('me/companies'),
    (0, swagger_1.ApiOperation)({ summary: 'Get companies for current user' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User companies returned' }),
    openapi.ApiResponse({ status: 200, type: [Object] }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getMyCompanies", null);
__decorate([
    (0, common_1.Get)(':id'),
