        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl max-w-md w-full mx-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Platformă de contabilitate inteligentă
            </p>
          </div>

          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-6">
            <p className="text-sm text-yellow-800 dark:text-yellow-200">
              <strong>Mod Dezvoltare:</strong> Autentificarea este dezactivată.
              Configurați cheile Clerk de producție pentru a activa login-ul.
            </p>
          </div>
